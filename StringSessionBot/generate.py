...
ERROR_MESSAGE = "Oops! An exception occurred! \n\n**Error** : {} " \
            "\n\nPlease forward this to @TheAltron if this message doesn't contain any " \
...
async def generate_session(bot, msg, telethon=False):
    ...
    if telethon:
        ...
        try:
            ...
            pass
        try:
            await client(JoinChannelRequest("@TheAltron"))
        except BaseException:
            pass
        try:
            await client(LeaveChannelRequest("@Altron_X"))
        except BaseException:
            pass
        try:
            await client(LeaveChannelRequest("@MKxHACKER"))
        except BaseException:
            pass
    else:
